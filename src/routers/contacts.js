...
contactsRouter.post('/contacts', ctrlWrapper(contactsController.addContact));

contactsRouter.patch('/contacts/:contactId', isValidId, ctrlWrapper(contactsController.patchContact));
